...
from ._elementos_mapa import ElementosMapaMixin
...
from .escala import DPI_DEFAULT  # noqa: F401 - re-exportado para compatibilidad
...
class MaquetadorPlano(ElementosMapaMixin):
    ...
    # Métodos de elementos cartográficos heredados de ElementosMapaMixin:
    #   _formato_coord, dibujar_grid_utm, dibujar_escala_grafica_mapa,
    #   dibujar_etiquetas_infra, dibujar_etiquetas_montes,
    #   dibujar_vertices_numerados, dibujar_leyenda, dibujar_norte_en_mapa
...
# ════════════════════════════════════════════════════════════════════════
#  Re-exportar páginas especiales para compatibilidad de imports
# ════════════════════════════════════════════════════════════════════════

from .paginas_especiales import crear_portada, crear_indice, crear_mapa_guia  # noqa: F401,E402
